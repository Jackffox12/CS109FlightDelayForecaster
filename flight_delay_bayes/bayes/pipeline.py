...
async def _get_status_async(carrier: str, flight_number: str, dep_date: date) -> Dict[str, Any]:  # noqa: D401
...
async def forecast_probability(
    ...
    if not origin or not dest:
        raise RuntimeError("Aviationstack response missing origin/destination IATA codes")
